  ...
  <div class="w980 fr">
    <div class="mbx">
      <ul class="ul11 clearfix nav-titile">
        <li><a style="cursor:pointer;" @click.prevent="$router.go(-1)">网点列表></a></li>
        <li>网点详情</li>
      </ul>
    </div>
          ...
          <tr>
            ...
            <td class="cor9 pdt20 pdb20 pdl30" colspan="3">
              <div v-if="info&&info.pictureUrl">
                <p v-for="(item,index) in info.pictureUrl" :key="index" class="fl mgr10"><img :src="item.thumbnailUrl" alt=""></p>
              </div>
    ...
    <div class="t-c mgt40 mgb50">
      ...
      <a style="cursor:pointer;" class="dinb w140 h40 lh40 t-c cor01 bgf1 ras4 hov8 mgl5">取消</a>
    </div>
    <!--弹窗1-->
