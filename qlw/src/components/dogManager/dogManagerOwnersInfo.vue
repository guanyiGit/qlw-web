<template>
  ...
  <div class="w980 fr">
    ...
    <div class="mgt15 k3">
      ...
      <div v-if="dogOwnerInfo&&dogOwnerInfo.tMemberCard" class="pdt10 pdb20 pdr30 borb2">
        <div class="ovh">
    ...
    <div class="mgt10 k3">
      ...
      <div class="pdt10 pdb20 pdr30 borb2">
        <div class="ovh">
          ...
          <div class="mgt10 ww50 fr">
            <span class="db w100 fl h40 lh40 cor0 pdl30">性质：</span>
            <div class="mgl100">
      ...
      <div v-if="dogOwnerInfo.myDogs">
        <table class="table2" width="100%" border="1">
          ...
          <tr v-if="dogOwnerInfo.myDogs && dogOwnerInfo.myDogs.length>0" v-for="(item,index) in dogOwnerInfo.myDogs" :key="index">
            ...
            <td><router-link :to="{name: 'dogManager_info',params:{dogId:item.dogId,name:'犬主详情'}}"><font color="blue">查看详情</font></router-link></td>
          </tr>
          </tbody>
        </table>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        dogOwnerId: this.$route.params.id,
        dogOwnerInfo: {},//犬主信息
      }
    },
    created() {
