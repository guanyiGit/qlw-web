  ...
  <div>
    ...
    <div class="w980 fr">
      ...
      <div class="div12 db">
        <div class="ovh mgt20">
          <div class="fl cor6 h40 lh40">
            <router-link style="cursor:pointer;" class="db fl hov8 corffa472 mgr35 pc9 pdl36" :to="{name:'hospital_addImmuneCard'}">免疫证办理</router-link>
          </div>
          <form class="fr db w380 h40 borbfbfbf ras20 rel" action="#">
            <input type="text" class="db ww100 h38 lh38 pdl15 cor3c3c3c bort" @dblclick="$event.target.select()" @keyup.enter="search1" v-model.trim="params1.searchKey" placeholder="免疫证号">
          ...
          <div class="t-c">
            <table class="table5" width="100%" border="1">
              ...
              <tr v-for="(item,index) in infos1" :key="index">
                ...
                <td class="t-c">
                  <router-link href="###" class="db cor009cff hov8" :to="{name:'hospital_checkImmuneCard',params:{'seqId':item.dogImmune.seqId}}">查看详情</router-link>
                  <router-link v-if="!item.tDogCard" class="db cor009cff hov8" :to="{name:'hospital_dogadd',params:{'immuneCardNum':item.dogImmune.immuneCardNum}}">办犬证</router-link>
                </td>
              </tr>
              </tbody>
            </table>
      ...
      <div class="div12 dn">
        <div class="ovh mgt20">
          <div class="fl cor6 h40 lh40">
            <router-link style="cursor:pointer;" class="db fl hov8 corffa472 mgr35 pc9 pdl36" :to="{name:'hospital_dogadd',params:{name:'证件办理'}}">犬证办理</router-link>
          </div>
          <form class="fr db w380 h40 borbfbfbf ras20 rel" action="#">
            <input type="text" class="db ww100 h38 lh38 pdl15 cor3c3c3c bort" @dblclick="$event.target.select()" @keyup.enter="search" v-model="params.input" placeholder="犬主姓名/犬主电话/犬证号/免疫证号">
            ...
            <table class="table5" width="100%" border="1">
              ...
              <tr v-for="(item,index) in infos" :key="index">
                ...
                <td class="t-c">
                  ...
                  <router-link class="dinb cor009cff hov8 mgr14" :to="{name:'dogManager_infos',params:{'dogId':item.dogId,'name':'证件办理'}}">查看详情</router-link>
                  <span class="cupo dinb cor009cff hov8" @click="renewal(item.dogId)">续期</span>
