  ...
  <div class="w980 fr">
    <div class="mbx">
      <ul class="ul11 clearfix">
        <li>
          <router-link :to="{name:'hospice_memberCardList'}">会员证管理&nbsp;&gt;&nbsp;</router-link>
        </li>
        <li>新增</li>
      </ul>
    </div>
    ...
    <form @submit.prevent="submit">
        ...
        <div class="pdt10 pdb20 pdr30 borb2">
          ...
          <div class="ovh">
            <div class="mgt10 ww50 fl">
              ...
              <div class="mgl100">
                <el-date-picker v-model="menberCradInfo.upTime" type="date" class="ww100 h40 lh40  borf1 ras4 pikes "  placeholder="起始日期"  format="yyyy年MM月dd日" > </el-date-picker>
            ...
            <div class="mgt10 ww50 fr">
              ...
              <div class="mgl100">
                <el-date-picker v-model="menberCradInfo.expireTime" type="date" class="ww100 h40 lh40  borf1 ras4 pikes "  placeholder="结束日期"  format="yyyy年MM月dd日" > </el-date-picker>
      ...
      <div class="t-c mgt40 mgb50">
        ...
        <input type="submit"  class="dinb w140 h40 lh40 t-c corw bgfbad82 ras4 hov8 bort cursutpt" value="保存">
  ...
  export default {
    ...
    methods: {
      ...
      submit(){
        ...
        let temp = configJS.userInfo;
        let issueOrgId = configJS.userInfo.organizationId;
        if(!issueOrgId){
          this.$alert("您的账户没有机构信息，无法办理！");
          return;
        }
        ...
        this.$axios({
          ...
          if(res.data.meta.success){
            this.$alert('证书办理成功,证件号码:'+res.data.data+" !");
            // this.$router.push({name:'hospice_memberCardList'})
          }else{
            this.$alert('办理失败！');
          }
        })
