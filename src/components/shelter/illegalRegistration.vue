          ...
          <div class="pdt10 pdb20 pdr30">
            <div class="ovh pdt10">
              <div class="mgt10 ww50 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">犬只标识号<b style="color: red">&nbsp;*</b></span>
                <div class="mgl130">
                  <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="collarNum" @change="selectpointByNum" placeholder="输入犬只标识号">
                </div>
              </div>
            ...
            <div class="ovh pdt10">
              <div class="mgt10 ww100 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">违法时间<b style="color: red">&nbsp;*</b></span>
                <div class="mgl130">
            ...
            <div class="ovh pdt10">
              <div class="mgt10 ww100 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">违法地点<b style="color: red">&nbsp;*</b></span>
                <div class="mgl130">
            ...
            <div class="ovh pdt10">
              <div class="mgt10 ww100 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">违法行为<b style="color: red">&nbsp;*</b></span>
                <div class="mgl130">
                  ...
                  <select v-model="violation.violationType"  class="ww100 h40 lh40 pdl20 borf1 ras4">
                    <option v-for="item in dicList" :value="item.dictionaryValue" :key="item.dictionaryValue">{{ item.dictionaryDescribe }}</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            <div class="ovh pdt10">
              <div class="mgt10 ww100 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">是否收容<b style="color: red">&nbsp;*</b></span>
            ...
            <div class="ovh pdt10">
              <div class="mgt10 ww100 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">处罚时间<b style="color: red">&nbsp;*</b></span>
                <div class="mgl130">
...
<script>
    ...
    export default {
      ...
      methods:{
        ...
        save() {
          ...
          if(this.violation.violationType=='' || this.violation.violationType==null){
            this.$alert("违法行为必须选择");
            return false;
          }
          //校验分数
  ...
  //查找违法类型字典表
  function  findBizTypes(_this) {
    _this.$axios({
      method:'get',
      url:'/biz/dictionary/findBizTypes',
      params:{dictionaryField:"violation_type"}
    }).then((res)=>{
      if(res.data.status==200 && res.data.data!=null){
        _this.dicList=res.data.data
      }
    }).catch((res)=>{
    })
  }
