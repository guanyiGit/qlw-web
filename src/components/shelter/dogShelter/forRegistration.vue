          ...
          <div class="pdt10 pdb20 pdr30 borb2">
            <div class="ovh">
              <div class="mgt10 ww50 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">犬只编号<b style="color: red">&nbsp;*</b></span>
                <div class="mgl100">
                  <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="data.dogCode">
                </div>
              </div>
              <div class="mgt10 ww50 fr">
                <span class="db w90 fl h40 lh40 cor0 pdl30">犬舍编号<b style="color: red">&nbsp;*</b></span>
                <div class="mgl90">
...
<script>
  ...
  import config from '../../../common/config.js'
    export default {
      ...
      methods:{
        save() {
          if(this.data.dogCode==null||this.data.dogCode=='') {
            this.$message("请输入犬只编号")
            return
          }
          if(this.data.dogName==null||this.data.dogName=='') {
            this.$message("请输入犬只名称")
            return
          }
          if(this.data.dogBreedType==null||this.data.dogBreedType=='') {
            this.$message("请选择犬品种")
            return
          }
          if(this.data.dogGender==null||this.data.dogGender=='') {
            this.$message("请选择性别")
            return
          }
          if(this.data.dogColorType==null||this.data.dogColorType=='') {
            this.$message("请选择毛色")
            return
          }
          if(this.data.healthStatus==null||this.data.healthStatus=='') {
            this.$message("请选择健康状态")
            return
          }
