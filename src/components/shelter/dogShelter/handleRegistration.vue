          ...
          <div class="t-c">
            <div class="ovh pdr30">
              <div class="mgt10 ww50 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">处理时间<b style="color: red">&nbsp;*</b></span>
                <div class="mgl100">
              ...
              <div class="mgt10 ww50 fr">
                <span class="db w90 fl h40 lh40 cor0 pdl30">处理方式<b style="color: red">&nbsp;*</b></span>
                <div class="mgl90">
            ...
            <div class="ovh pdr30">
              <div class="mgt10 ww50 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">处理原因<b style="color: red">&nbsp;*</b></span>
                <div class="mgl100">
    ...
    export default {
      ...
      ,mounted(){
        ...
        save() {
          ...
          if(this.data.handleTime=='' || this.data.handleTime==null){
            this.$alert("处理时间不能为空");
            return false;
          }
          if(this.data.handleWay=='' || this.data.handleWay==null){
            this.$alert("处理方式不能为空");
            return false;
          }
          if(this.data.handleReason=='' || this.data.handleReason==null){
            this.$alert("处理原因不能为空");
            return false;
          }
          this.$axios({
