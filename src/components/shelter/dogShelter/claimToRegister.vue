            ...
            <div class="fl w980 pdr30">
              <div class="ovh pdt10">
                <div class="mgt10 ww50 fl">
                  <span class="db w100 fl h40 lh40 cor0 pdl30">认领时间<b style="color: red">&nbsp;*</b></span>
                  <div class="mgl100">
                ...
                <div class="mgt10 ww50 fr">
                  <span class="db w90 fl h40 lh40 cor0 pdl30">认领人<b style="color: red">&nbsp;*</b></span>
                  <div class="mgl90">
    ...
    export default {
      ...
      methods:{
        save() {
          ...
          if(this.data.claimName=='' || this.data.claimName==null){
            this.$alert("认领人不能为空");
            return false;
          }
