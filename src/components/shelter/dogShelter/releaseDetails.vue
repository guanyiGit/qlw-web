            ...
            <div class="fl w950 pdt10">
              ...
              <div class="ovh">
                <div class="mgt10 ww100 fl">
                  ...
                  <div class="mgl100">
                    <input v-if="dogInfo&&dogInfo.collectionTime" type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-bind:value="dogInfo.collectionTime | formatDate('yyyy-MM-dd')" :disabled=true>
                    <input v-else type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" :disabled=true>
                  </div>
                </div>
              </div>
              <div class="ovh">
              ...
              <div class="ovh">
                <div class="mgt10 ww100 fl">
                  ...
                  <div class="mgl100">
                    <img v-if="dogInfo" v-bind:src="dogInfo.thumbnailUrl" alt="" style="height: 120px;width: 120px" @click="showBigImg(dogInfo.thumbnailUrl)">
