      ...
      <div class="div2 db">
        <div class="ovh mgt20">
          <div class="fl cor6 h40 lh40 mgl10">
            ...
            <a style="cursor:pointer;" class="db fl hov8 corffa472 mgr35 pc14 pdl36" @click="publishBatch">发布到领养平台</a>
          </div>
                ...
                <div class="ovh t-l">
                  ...
                  <div class="mgl98">
                    <div class="ovh">
                      ...
                      <p class="fl cor9 h22 lh22">犬龄：{{item.dogAge}}岁</p>
                    </div>
          ...
          if (blackIdList.length > 0) {
            this.$confirm('确定撤回吗？').then(_ => {
              this.$axios({
                ...
                // traditional: true,
                data: JSON.stringify(blackIdList),
              }).then((res) => {
                if (res.data.status == 200) {
                  inShelter(this);
                  release(this);
