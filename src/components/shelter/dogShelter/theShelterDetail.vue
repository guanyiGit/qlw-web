          ...
          <div>
            <table class="table10 t-c" width="100%" border="1">
              ...
              <tr>
                ...
                <td>性别</td>
                <td class="cor9">{{dogInfo?dogInfo.dogGender==0?'雄':'雌':''}}</td>
              </tr>
              <tr>
                <td>犬龄</td>
              ...
              <tr>
                ...
                <td class="cor9 pdt20 pdb20 pdl30" colspan="3">
                  <p v-if="dogInfo&&dogInfo.thumbnailUrl" class="fl mgr10"><img class="rel z1" v-bind:src="dogInfo.thumbnailUrl" @click="showBigImg(dogInfo.thumbnailUrl)" style="width: 120px;height: 120px"></p>
