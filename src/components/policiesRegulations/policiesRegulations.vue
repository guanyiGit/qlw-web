    ...
    <div class="w1200 c-b mgt40">
      <div class="ovh">
        <div class="fl cor6 h40 lh40">
          ...
          <a style="cursor:pointer;" class="db fl tab1 mgr35 active">政策法规</a>
          <a id="jyqz" style="cursor:pointer;" class="db fl tab1">禁养犬种</a>
        </div>
        <form class="fr db w380 h40 borbfbfbf ras20 rel form first" action="#">
          <input id="input1" type="text" class="db ww100 h38 lh38 pdl15 cor3c3c3c bort" @keyup.enter="policiess" placeholder="标题">
          <input value="" class="in1 db abs z100 top0 bort right0" v-on:click="policiess">
        </form>
        <form class="fr db w380 h40 borbfbfbf ras20 rel form last" action="#" style="display: none">
          <input id="input2" type="text" class="db ww100 h38 lh38 pdl15 cor3c3c3c bort" @keyup.enter="banDogs" placeholder="犬种名称">
      ...
      <div class=" pdt10 pages">
        <div class="db tab2 first">
          <ul class="ul05">
            <li v-for="item in infos">
              <router-link href="###" class="db h50 lh50 pdl24 pdr10 ovh fs14 cor3 pc3" :to="{name:'infoDetails',params:{id:item.informationId,type:0}}">
        ...
        <div class="dn tab2 last">
          <ul class="mgt22 ovh ul06">
            <li v-for="item in dogs" class="fl w236 hov8">
              <a href="###" class="db">
                <img class="ww100" style="height: 200px" v-bind:src="item.url" alt="">
    ...
    export default {
      ...
      mounted(){
        ...
        if (this.$route.params.vall==1) {
          $("#jyqz").addClass('active').siblings().removeClass('active');
    ...
    function policiesRegulationss(){
      ...
      _this.$axios({
        ...
        if (res.data.status == 200) {
          ...
          _this.pageData.curPage= params.data.pageNum//当前页吗
          _this.pageData.pageSize= params.data.pageSize//页面大小
        }
      })
    }
    function banDogs(){
      ...
      _this.$axios({
        ...
        if (res.data.code == "000000") {
          ...
          _this.pageData1.totalCount = res.data.result.page.totalCount
          _this.pageData1.curPage= params.data1.num//当前页吗
          _this.pageData1.pageSize= params.data1.size//页面大小
        }
      })
    }
</script>
