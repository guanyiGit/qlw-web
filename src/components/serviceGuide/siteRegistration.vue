    ...
    <form action="#">
      ...
      <div class="w1200 c-b mgt30 bord">
        ...
        <div class="pdt10 pdb60 pdl30 pdr30">
          <div class="ovh">
            ...
            <!--</div>-->
            <div class="mgt10 w550 fr">
              <span class="db w90 fl h40 lh20 cor0">统一社会<br>信用代码</span>
              <!--<el-tooltip class="item" effect="dark"-->
          ...
          <div class="ovh">
            <div class="mgt10 w550 fl">
              <span class="db w90 fl h40 lh40 cor0">注册号</span>
              <div class="mgl90">
                <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="data.registerNumber">
              </div>
            </div>
            <div class="mgt10 w550 fr">
              <span class="db w90 fl h40 lh40 cor0">固定电话</span>
              <!--<el-tooltip class="item" effect="dark"-->
                          <!--:disabled="data.fixedPhone&&/^((0\d{2,3})-)(\d{7,8})(-(\d{3,}))?$/.test(data.fixedPhone)?true:false"-->
                          <!--content="输入值不合法" placement="right">-->
              <!--</el-tooltip>-->
              <div class="mgl90">
                <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="data.fixedPhone">
              </div>
            </div>
          </div>
          <div class="ovh">
            ...
            <div class="mgt10 w550 fr">
              <span class="db w90 fl h40 lh40 cor0">联系人电话<font color="red"> *</font></span>
              <!--<el-tooltip class="item" effect="dark"-->
              <!--:disabled="data.fixedPhone&&/^((0\d{2,3})-)(\d{7,8})(-(\d{3,}))?$/.test(data.fixedPhone)?true:false"-->
              <!--content="输入值不合法" placement="right">-->
              <!--</el-tooltip>-->
          ...
          <div class="ovh">
            <span class="db w90 fl h40 lh40 cor0 mgt10">所属地区<font color="red"> *</font></span>
      ...
      <div class="w1200 c-b mgt18 bord">
        ...
        <div class="pdt10 pdb60 pdl30 pdr30">
          ...
          <div class="ovh">
            <div class="mgt20 w550 fl">
              <span class="db w90 fl h40 lh40 cor0">有效期限<font color="red"> *</font></span>
              <div class="mgl90">
          ...
          <!--<div class="ovh">-->
            ...
            <!--</div>-->
            <!--<div class="mgt20 w550 fr">-->
              <!--&lt;!&ndash;<span class="db w100 fl h40 lh40 cor0"><img src="../../../static/images/bg14.png" alt=""></span>&ndash;&gt;-->
              <!--<div class="mgl90">-->
          ...
          <!--<div class="mgt20">-->
            <!--<span class="db w90 fl h40 lh40 cor0">图片</span>-->
            <!--<div class="mgl90">-->
              <!--&lt;!&ndash;<img src="../../../static/images/34.png" alt="">&ndash;&gt;-->
              <!--<img-upload class="ovh" ref="imgup2"></img-upload>-->
            <!--</div>-->
          <!--</div>-->

          <p class="mgt20 cor0 h20 lh20"><span class="db fl mgr10 sp2 w39 h20 lh20 t-c corw fs12">2</span>工商营业执照</p>
          <div class="ovh">
            <div class="mgt20 w550 fl">
              <span class="db w90 fl h40 lh40 cor0">证件号码<font color="red"> *</font></span>
              <div class="mgl90">
          ...
          <p class="mgt20 cor0 h20 lh20"><span class="db fl mgr10 sp2 w39 h20 lh20 t-c corw fs12">3</span>兽医资格证</p>
          <div class="ovh">
            <div class="mgt20 w550 fl">
              <span class="db w90 fl h40 lh40 cor0">证件号码<font color="red"> *</font></span>
              <div class="mgl90">
      ...
      <div class="w1200 c-b mgt30 bord">
        <p class="fs16 cor0 fb h60 lh60 bgf1 pdl30">系统登陆账号信息</p>
        <div class="pdt10 pdb60 pdl30 pdr30">
          <div class="ovh">
            <div class="mgt10 w1100 fl">
              <span class="db w90 fl h40 lh40 cor0">登陆账号<font color="red"> *</font></span>
              <div class="mgl90">
                <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="data.username">
              </div>
            </div>
          </div>
          <div class="ovh">
            <div class="mgt10 w1100 fl">
              <span class="db w90 fl h40 lh40 cor0">登陆密码<font color="red"> *</font></span>
              <div class="mgl90">
                <input type="password" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="data.password">
              </div>
            </div>
          </div>
          <div class="ovh">
            <div class="mgt10 w1100 fl">
              <span class="db w90 fl h40 lh40 cor0">确认密码<font color="red"> *</font></span>
              <div class="mgl90">
                <input type="password" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="data.confirmPassword" @blur="checkPassWord">
              </div>
            </div>
          </div>
          <div class="t-c mgt40">
  ...
  export default {
    ...
    methods: {
      ...
      save() {
        ...
        // if (!this.data.fixedPhone || !/^((0\d{2,3})-)(\d{7,8})(-(\d{3,}))?$/.test(this.data.fixedPhone)) {
        //   this.$alert("固定电话格式有误！");
        //   return;
        // }
        ...
        this.$axios({
          ...
          if (res.data.status == 200 && res.data.data != null && res.data.data != "") {
            ...
            this.$axios({
              method:'get',
              url:'/biz/serviceSite/selectPetHCardIds',
              params:{organizationId:res.data.data}
            }).then((res) => {
              if (res.data.status == 200 && res.data.data != null) {
                var dataa=res.data.data
                if (dataa.length>0) {
                  for (var i=0;i<dataa.length;i++) {
                    if (dataa[i].petHCardType==0) {
                      this.$refs.imgup1.upload({type: 8, id: dataa[i].petHCardId});//图片上传
                    }else if (dataa[i].petHCardType==1) {
                      //this.$refs.imgup2.upload({type: 8, id: dataa[i].petHCardId});//图片上传
                    }else if (dataa[i].petHCardType==2) {
                      this.$refs.imgup3.upload({type: 8, id: dataa[i].petHCardId});//图片上传
                    }else if (dataa[i].petHCardType==3) {
                      this.$refs.imgup4.upload({type: 8, id: dataa[i].petHCardId});//图片上传
                    }
                  }
                }
                this.$alert("录入成功!", "添加提示").then(_ => {
                  this.$router.push({name:'serviceGuide',params:{vall:1}});//其中certificateDealt是你定义的一个路由模块
                }).catch(_ => {
                });
              }
            }).catch(_=>{
