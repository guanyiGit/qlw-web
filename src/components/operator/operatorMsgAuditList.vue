<template>
  ...
  <div class="w980 fr">
    <div class="ovh div1 h50 rel">
      ...
      <a href="javascript:void(0);" class="fl db fs16 cor3c3c3c w200 h50 lh50 t-c" @click.prevent="checkTab = 3">已审核</a>
    </div>
    ...
    <div class="div12 dn mgt20">
      <div class="ovh">
        ...
        <form class="fr db w380 h40 borbfbfbf ras20 rel" action="#">
          <input type="text" class="db ww100 h38 lh38 pdl15 cor3c3c3c bort" placeholder="标题" v-model="keyword1">
          <input type="submit" value="" class="in1 db abs z100 top0 bort right0" @click.prevent="searchKey">
        </form>
      </div>
      <div class="ovh k3 mgt20">
        <table class="table11" width="100%">
          ...
          <tr v-for="(item,index) in  msgList" :key="index" v-if="msgList && msgList.length>0">
            ...
            <td>
              <router-link style="cursor:pointer;" class="dinb hov8 cor009cff" :to="{name:'operator_listInfoDetail',params:{'id':item.informationId}}">查看</router-link>
            </td>
          </tr>
          </tbody>
        </table>
