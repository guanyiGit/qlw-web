      ...
      <div style="width: 50%;height: 100%;float: right">
        <div class="w1200 c-b bord" style="width: 100%;">
          ...
          <div class="pdt10 pdb60 pdl30 pdr30" style="font-size: 18px;margin-left: 30px">
              ...
              <div class=" ovh">
                <ul class="ovh fl ul10" >
                  <li class="fl" v-if="hospital.pictureUrl&&hospital.pictureUrl.length<1">
                    <img src="/static/images/17-1.png" alt="" style="width: 150px;height: 120px"></li>
                  <li class="fl"v-for="(item,index) in hospital.pictureUrl">
                    <img v-if="item.imageUrl" :src="item.imageUrl" alt="" style="width: 150px;height: 120px" @click="showBigImg(item.imageUrl)"></li>
                </ul>
              </div>
            </div>
            <div class="mgt20">
              ...
              <div class=" ovh">
                <ul class="ovh fl ul10">
                  <li class="fl" v-if="hospital.orgCardImgs&&hospital.orgCardImgs.length<1">
                    <img src="/static/images/28-8.png" alt="" style="width: 150px;height: 120px"></li>
            ...
            <div class="mgt40">
              <input type="submit" style="width: 20%;" class="dinb w140 h40 lh40 corw bgfbad82 ras4 hov8 bort" value="预约"  @click="skipToAdd">
  ...
  import moment from 'moment'
    export default {
      ...
      methods:{
        ...
        skipToAdd:function () {
          this.$router.push({name:'serviceGuide', params:{ type:1,orgId:this.hospital.organizationId,orgName:this.hospital.organizationName}})
        },
        goTo(){
          var that = this;
          // 创建点标记
