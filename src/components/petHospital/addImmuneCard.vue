        ...
        <div class="pdt10 pdb20 pdr30">
          <!--<div class="ovh">-->
            ...
            <!--<div class="mgt10 ww50 fr">-->
              <!--<span class="db w100 fl h40 lh40 cor0 pdl30">签发机构</span>-->
              <!--<div class="mgl100">-->
                <!--<input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4">-->
              <!--</div>-->
            <!--</div>-->
            ...
            <div class="mgt10 ww50 fl">
              ...
              <div class="mgl100">
                <el-date-picker v-model="dogInfo.dogImmune.lssueTime" type="date" class="ww100 h40 lh40 borf1 ras4 dataSelect"
                                placeholder="选择签发日期" :format="datePattern" :disabled="true"></el-date-picker>
                <!--<input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4">-->
              </div>
            </div>
          </div>
        ...
        <div class="pdt10 pdb20 pdr30">
          ...
          <div class="ovh">
            <!--<div class="mgt10 ww50 fl">-->
              ...
              <!--<div class="mgl100">-->
                <!--&lt;!&ndash;<input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4">&ndash;&gt;-->
            ...
            <div class="mgt10 ww50 fr">
              ...
              <div class="mgl100">
                <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model.trim="dogInfo.dogAge">
              </div>
            </div>
            <div class="mgt10 ww50 fr">
          ...
          <!--<div class="ovh">-->
            ...
            <!--</div>-->
            <!--<div class="mgt10 ww50 fr">-->
              <!--<span class="db w100 fl h40 lh40 cor0 pdl30">母体</span>-->
              <!--<div class="mgl100">-->
        ...
        <div class="pdb20 pdr30 ovh">
          <div class="w950 pdt10">
            <div class="ovh">
              ...
              <div class="mgt10 ww50 fr">
                <span class="db w100 fl h40 lh40 cor0 pdl30"></span>
                <span type="text" id="tishi" class="ww100 h40 lh40 pdl20 borf1 ras4" style="color: red;display: none">已查到犬主信息</span>
              </div>
            </div>
            <div id="remaining">
            <div class="ovh">
              ...
              <div class="mgt10 ww50 fr">
                <span class="db w100 fl h40 lh40 cor0 pdl30">性质<b style="color: red">&nbsp;*</b></span>
                <div class="mgl100">
            ...
            <div class="ovh">
              ...
              <div class="mgt10 ww50 fr">
                <span class="db w100 fl h40 lh40 cor0 pdl30">所属部门</span>
                <div class="mgl100">
            ...
            <div class="ovh">
              ...
              <!--</div>-->
              <!--<div class="mgt10 ww50 fr">-->
                <!--<span class="db w100 fl h40 lh40 cor0 pdl30">电子邮箱</span>-->
                <!--<div class="mgl100">-->
                  <!--<input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="dogInfo.dogOwner.eMail">-->
                <!--</div>-->
              <!--</div>-->
              <div class="mgt10 ww50 fl">
                <span class="db w100 fl h40 lh40 cor0 pdl30">电子邮箱<b style="color: red">&nbsp;*</b></span>
                <div class="mgl100">
    ...
    export default {
      ...
      methods:{
        save(){
          ...
          if(!this.dogInfo.dogOwner.dogOwnerType){
            alertMsg='犬主性质必须填写'
            flag = false
          }
        ...
        selectOwner:function () {
          this.$axios({
            ...
            if (res.data.data!=null && JSON.stringify(res.data.data) !="[]") {
              ...
              this.dogInfo.dogOwner.dogOwnerId=null;
              this.dogInfo.dogOwner.dogOwnerName=null;
              this.dogInfo.dogOwner.dogOwnerType=null;
              this.dogInfo.dogOwner.sex=null;
              this.dogInfo.dogOwner.districtId=null;
              this.dogInfo.dogOwner.postalCode=null;
              this.dogInfo.dogOwner.eMail=null;
              this.dogInfo.dogOwner.address=null;
