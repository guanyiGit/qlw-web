    ...
    <div class="w1200 c-b mgt40">
      <div class="ovh">
        ...
        <form class="fr db w380 h40 borbfbfbf ras20 rel form" action="#">
          <input id="input1" type="text" class="db ww100 h38 lh38 pdl15 cor3c3c3c bort" @keyup.enter="informations" placeholder="标题">
        ...
        <div class="db tab2">
          <ul class="ul05">
            <li v-for="item in infos">
              <router-link href="###" class="db h50 lh50 pdl24 pdr10 ovh fs14 cor3 pc3" :to="{name:'infoDetails',params:{id:item.informationId,type:2}}">
