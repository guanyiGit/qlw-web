  ...
  <div class="w980 fr">
    ...
    <div class="ovh">
      <div class="fl cor6 h40 lh40">
        <!--<router-link class="db fl hov8 corffa472 mgr35 pc9 pdl36" :to="{name:'dogManager_dogadd',params:{name:'犬只档案'}}">办理犬证</router-link>-->
      ...
      <form class="fr db w380 h40 borbfbfbf ras20 rel" action="#">
        <input type="text" class="db ww100 h38 lh38 pdl15 cor3c3c3c bort"
               v-model="params.input" @keyup.enter="search" placeholder="犬主姓名/电话号/犬证号/免疫证号/标示牌号">
    ...
    <div class="mgt10 k3">
      ...
      <div class="t-c">
        <table class="table5" width="100%" border="1">
          <tbody>
          <tr>
            <td class="cor0 h60 bgf1 teCen w50" @click="selectAll" >全选</td>
            <td class="cor0 h60 bgf1 teCen t-l pdl100" >犬只信息</td>
            <td class="cor0 h60 bgf1 teCen">犬主</td>
            <td class="cor0 h60 bgf1 teCen nocard">犬证号</td>
            <td class="cor0 h60 bgf1 teCen nocard">免疫证号</td>
            <td class="cor0 h60 bgf1 teCen nocard">创建时间</td>
          ...
          <tr v-for="(item,index) in dogList" :key="index">
            ...
            <td class="pdt20 pdb20">
              <div class="ovh t-l">
                <div class="fl w76">
                  <img class="codImg" :src="item.url?item.url:'/static/images/dog-none.png'" alt="" >
                </div>
                <div class="mgl98">
                  <div class="cor0 h22 lh22">
                    {{item.dogName}}
                    <a href="###" class="dinb a5 w66 h22 lh22 t-c fs12 corw hov8 mgl20"
                       v-if="item.endTime && item.endTime>new Date()">犬证过期</a>
                  ...
                  <div class="cor9 mgt10 ovh">
                    ...
                    <p class="fl">{{item.colour?'毛色：'+item.colour:'-'}}</p>
                  </div>
                </div>
              </div>
            </td>
            ...
            <td class="teCen nocard">{{item.dogCardNum?item.dogCardNum:'-'}}</td>
            <td class="teCen nocard">{{item.immuneCardNum?item.dogCardNum:'-'}}</td>
            <td class="teCen nocard">{{item.createTime | formatDate('yyyy-MM-dd')}}</td>
            <td class="t-c">
