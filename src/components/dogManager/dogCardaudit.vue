<template>
  ...
  <div class="w980 fr">
            ...
            <div class="mgl100 ovh">
              <ul class="ovh fl ul10">
                <li class="fl" v-for="(item,index) in dogInfos.urlLsit" :key="index">
                  <img :src="item.imageUrl" alt="" style="width: 202px;height: 180px;" v-if="index<3" @click="showBigImg(item.imageUrl)">
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="mgt10 k3">
      ...
      <div class="pdt10 pdb20 pdr30 borb2">
        <div class="ovh">
          ...
          <div class="mgt10 ww50 fr">
            <span class="db w90 fl h40 lh40 cor0 pdl30">设备ID<b style="color: red"></b></span>
            <div class="mgl90">
              <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="insertParams.deviceId" maxlength="50">
            </div>
          </div>
        </div>
        <div class="ovh">
    ...
    <!--弹窗2-->
    <!--弹窗   说明。.db--显示，.dn--隐藏-->
    <div class="T db Tt" style="display: none;z-index: 2" @click="imgHide()">
...
<script>
  ...
  import $ from 'jquery'
    ...
    if (_this.insertParams.status==1) {
      ...
      if (_this.insertParams.endTime<_this.insertParams.startTime) {
        _this.$alert("有效期限需大于签发日期！")
        return
      }
    }
      _this.$axios({
