  ...
  <div class="w980 fr">
    ...
    <div class="mgt10 k3 t-c">
      <table class="table5" width="100%" border="1">
        <tbody>
        <tr>
          <td class="cor0 h60 bgf1" style="width: 14%">喂药时间</td>
          <td class="cor0 h60 bgf1" style="width: 14%">药品名称</td>
          <td class="cor0 h60 bgf1" style="width: 14%">药品厂家及批号</td>
          <td class="cor0 h60 bgf1" style="width: 14%">兽医</td>
          <td class="cor0 h60 bgf1" style="width: 14%">下次喂药时间</td>
          <td class="cor0 h60 bgf1" style="width: 14%">创建时间</td>
          <td class="cor0 h60 bgf1" style="width: 14%">备注</td>
        </tr>
        <tr v-for="(item,index) in list":key="index">
          ...
          <td class="cor3" v-else>···</td>
          <td class="cor3" v-if="item.create_date">{{item.create_date|formatDate(dataFormatPattern)}}</td>
          <td class="cor3" v-else>···</td>
      ...
      <div class="tan6 abs bgw k3 db" style="height: 640px;">
        ...
        <div class="ovh">
          <div class="mgt10 fl" style="width: 98%;">
            ...
            <div class="mgl100">
              <input type="text" class="ww100 h40 pdl20 borf1 ras4" style="height: 70px" v-model="addImm.remarks">
            </div>
          </div>
        </div>
...
<script>
  ...
  function initData(_this) {
    _this.$axios({
      ...
      params: {"org_id":conf.userInfo.organizationId,"dog_id": _this.$route.params.VIId
      ...
      console.log("喂药记录_this.list"+JSON.stringify(_this.list))
    }).catch((res)=>{
  ...
  function add(_this){
    try{
      ...
      drugRecord.org_id=conf.userInfo.organizationId
      drugRecord.dog_id=_this.$route.params.VIId
