        ...
        <div class="pdt10 pdb20 pdr30 borb2">
          ...
          <div class="ovh">
            ...
            <div class="mgt10 ww50 fr">
              <span class="db w90 fl h40 lh40 cor0"><img src="/static/images/bg14.png" alt=""></span>
              <div class="mgl90">
        ...
        <div class="pdt10 pdb20 pdr30 borb2">
          <div class="ovh">
            ...
            <div class="mgt10 ww50 fr">
              ...
              <div class="mgl90">
                <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" disabled :value="dogAllInfo.immuneCard?dogAllInfo.immuneCard.orgName:''">
              </div>
            </div>
          </div>
