    ...
    <div class="mbx">
      <ul class="ul11 clearfix">
        <li>
          ...
          <a @click.prevent="$router.go(-1)">{{$route.params.name?$route.params.name:'上一页'}}&nbsp;&gt;&nbsp;&nbsp;</a>
        </li>
        <li>查看详情</li>
      </ul>
      <a style="cursor:pointer;width: 100px;height: 35px;margin-top: -25px" class="dinb w140 h40 lh40 t-c corw bgfbad82 ras4 hov8 mgl5 fr" @click.prevent="$router.go(-1)">返回</a>
    </div>
        ...
        <div class="fl w945 pdt10">
          ...
          <div class="ovh">
            ...
            <div class="mgt10 ww50 fr">
              ...
              <div class="mgl90">
                <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" :value="dogInfos.dogInfo.weight+'公斤'"
                       :disabled="isDisabled">
              </div>
            </div>
          </div>
            ...
            <div class="mgl100 ovh">
              <ul class="ovh fl ul10 h180 ww100 borbfc695">
                <li class="fl" v-for="(item,index) in dogInfos.urlLsit" :key="index">
                  <img :src="item.imageUrl" alt="" class="img" v-if="index<=3" @click="showBigImg(item.imageUrl)">
                </li>
...
<!--。。。。。。。。。。。。。。。-->
    <div class="mgt10 k3">
      ...
      <div class="pdt10 pdb20 pdr30 borb2" v-if="dogInfos.devices">
        <div v-if="device0">
        <div class="ovh">
          <div class="mgt10 ww50 fl">
            <span class="db w100 fl h40 lh40 cor0 pdl30">设备ID：</span>
            <div class="mgl100">
              <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" :value="device0.imei"
                     :disabled="isDisabled">
            </div>
          </div>
          <div class="mgt10 ww50 fr">
        ...
        <div class="ovh">
          <div class="mgt10 ww50 fl">
            ...
            <div class="mgl100">
              <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" :value="device0.productionTime|formatDate('yyyy-MM-dd')"
                     :disabled="isDisabled">
            </div>
          </div>
        </div>
        ...
        <div class="ovh" v-if="device1">
          <div class="mgt10 ww50 fl">
            <span class="db w100 fl h40 lh40 cor0 pdl30">项圈编号：</span>
            <div class="mgl100">
              <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" :value="device1.deviceNumber"
                     :disabled="isDisabled">
            </div>
          </div>
          <div class="mgt10 ww50 fr">
            <span class="db w90 fl h40 lh40 cor0 pdl30">出厂日期：</span>
            <div class="mgl90">
              <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" :value="device1.productionTime|formatDate('yyyy-MM-dd')"
                     :disabled="isDisabled">
            </div>
          </div>
        </div>
    ...
    <div class="mgt10 k3">
      ...
      <div class="pdt10 pdb20 pdr30" v-if="dogInfos.dogOwners">
        ...
        <div class="ovh">
          ...
          <div class="mgt10 ww50 fr">
            <span class="db w90 fl h40 lh40 cor0 pdl30">所属社区：</span>
            <div class="mgl90">
    ...
    <!--弹窗   说明。.db--显示，.dn--隐藏-->
    <div class="T db" style="display: none;z-index: 2" @click="imgHide()">
    ...
    _this.$axios({
      ...
      console.log(res)
        if (res.data.code == '000000' && res.data.result != null) {
          ...
          if (_this.dogInfos.devices.length>0){
            for (var i=0;i<_this.dogInfos.devices.length;i++) {
              if (_this.dogInfos.devices[i].deviceType==0) {
                _this.device0=_this.dogInfos.devices[i];//小设备
              }else if (_this.dogInfos.devices[i].deviceType==1){
                _this.device1=_this.dogInfos.devices[i];//大设备/项圈
              }
            }
          }
        }
