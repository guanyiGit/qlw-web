  ...
  <div class="w980 fr test">
    <div class="mbx">
      <ul class="ul11 clearfix">
        <li>
          <a href="###" @click.prevent="$router.go(-1)">黑名单 &gt; </a>
        </li>
        <li>新增</li>
      </ul>
    </div>
        ...
        <div class="w730 fl">
          ...
          <div class="ovh pdt10">
            <div class="mgt10 ww50 fl">
              ...
              <div class="mgl100">
                <input type="text" class="ww100 h40 lh40 pdl20 borf1 ras4" v-model="blackInfo.phone" @blur="check(blackInfo.phone)">
              </div>
            </div>
            <div class="mgt10 ww50 fr">
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      submit(){
        if(this.isExist==false && this.blackInfo.phone!=''){
          this.$alert("黑名单已存在，不能再次加入！")
          return;
        }
  ...
  //根据电话来判断是否已经在黑名单
  function check(_this,phone) {
    _this.$axios({
      url: "/biz/balck/check",
      params:{string:phone}
    }).then((res) => {
      console.log(res.data)
      _this.isExist=res.data.data;
    }).catch((res) => {
